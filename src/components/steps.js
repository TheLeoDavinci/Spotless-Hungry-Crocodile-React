...
Steps.defaultProps = {
  ...
  step3Title: 'Get Started Today',
  step2Title: 'Choose the Right Solution',
  step2Description:
    'Select from our email, trade show, conference, and digital marketing services.',
  step4Description:
    'See the positive impact our services can have on your business growth.',
  step4Title: 'Experience Growth',
  step1Description:
    'Explore our range of services tailored to meet your specific needs.',
  step3Description:
    'Contact us to begin enhancing your business with our efficient solutions.',
}
